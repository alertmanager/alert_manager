...
- **v2.3.0**/   2018-06-19
	...
	- Added support to override owner, category, subcategory, tags, display_fields with event results
...
- **2018-06-19** my2ndhead
	- Added support to override owner, category, subcategory, tags, display_fields with event results, while preserving owner and urgency, when manually overriden by user
