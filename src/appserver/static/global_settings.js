...
require.config({
    paths: {
        ...
        GlobalSettingsView: "../app/" + app_name + "/views/globalsetttingsview",
    },
});
...
require([
    ...
    // Custom files
    "GlobalSettingsView",
], function(Backbone, jquery, GlobalSettingsView) {
    var globalsettingsview = new GlobalSettingsView({
        // Sets the element that will be used for rendering
        el: jquery("#main_container"),
    });

    globalsettingsview.render();
});