...
class NotificationSchemesController(controllers.BaseController):

    @expose_page(must_login=True, methods=['POST']) 
    def delete_notification_scheme(self, key, **kwargs):
    ...
    @expose_page(must_login=True, methods=['POST']) 
    def save_notification_scheme(self, contents, **kwargs):
